...
const COLORS: string[] = [
  "#3c2b5e","#65000b","#640524","#06009f","#1a3c00","#36362f","#003c24",
  "#0c3d00","#003d00","#492f00","#610b3a","#5d183a","#002f73","#35353b",
  "#353535","#5f1531","#650000","#65000e","#660000","#442f37","#520f68",
  "#003753","#133946","#2f363d","#393246","#2a3a09","#233a2b","#403038",
  "#31372b","#47007e","#253933","#003a40","#0b3d00","#4a2f00","#3e3238",
  "#202f6e","#552721","#5c0053","#3f3138","#41330e","#581018","#00384e",
  "#23374a","#442466","#363628","#303730","#5e0b47","#452f30","#413316",
  "#303637","#281294","#213168","#003851","#003a41","#480000","#640f0f",
  "#2b3832","#492d35","#601a14","#3a3241","#003368","#1f3c00","#4f2c00",
  "#5d1e16","#343444","#001e93","#630b26","#650715","#53243c","#203c00",
  "#440082","#0a3c29","#1c3c1c","#193753","#5e034c","#372d60","#2a3643",
  "#462b4c","#003949","#463100","#1b3b2c","#4b186e","#2f363c","#143c1e",
  "#003b36","#003c2e","#0d3d12","#30363c","#31372a","#502800","#382f57",
  "#2f372f","#58184d","#650004","#2b3838","#001048","#502000","#2e3544",
  "#4c2e00","#162685","#003c2b","#640027","#650a0e","#00394c","#452e3e",
  "#023753","#5c0052","#293931","#1e393a","#55233a","#3a3434","#383038",
  "#481810","#401820","#65001d","#2a373e","#093d17","#093d20","#303038",
  "#393600","#5a1f30","#413300","#0c3c30","#03394d","#502820","#26364d",
  "#4b2c33","#5f1b00","#00326a","#223845","#472f2f","#452c46","#650016",
  "#3d3144","#432d4b","#002e77","#00384d","#2b3924","#582132","#002d7a",
  "#611714","#202040","#003465","#1e306b","#3b3333","#5c1f21","#003754",
  "#35353c","#580060","#103050","#592223","#183050","#452463","#4b2c34",
  "#2c3925","#1c3a3a","#37370e","#083070"
];
...
export async function getAccentColorFromUrl(
    ...
    try {
        ...
        if (!paletteRgb.length) {
            // @ts-ignore
            const single = await ColorThief.getColor(buffer).catch(() => null);
            if (single && Array.isArray(single) && single.length >= 3
